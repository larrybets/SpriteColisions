        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (line.startsWith("ENEMY=")) {
                    ...
                    enemy.x1 = Integer.parseInt(coors[0].trim()) * 20;
                    enemy.x2 = Integer.parseInt(coors[1].trim()) * 25;
                ...
                if (line.startsWith("ENEMY2=")) {
                    ...
                    enemy2.y = Integer.parseInt(coors[2].trim()) * 16 - 6;
                    enemy2.x = enemy2.x1;
                    game.addEnemy(enemy2);
                    continue;
                }
                if (line.startsWith("BOMBA=")) {
                    String[] parts = line.split("=");
                    String[] coors = parts[1].trim().split(",");
                    Bomba bomba = new Bomba(game);
                    bomba.x1 = Integer.parseInt(coors[0].trim()) * 16;
                    bomba.x2 = Integer.parseInt(coors[1].trim()) * 16;
                    bomba.y = Integer.parseInt(coors[2].trim()) * 16 - 6;
                    bomba.x = bomba.x1;
                    game.addEnemy(bomba);
                    continue;
                }
